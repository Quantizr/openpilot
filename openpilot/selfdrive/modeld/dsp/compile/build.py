...
from openpilot.selfdrive.modeld.dsp.megakernel import MegakernelLayout
from openpilot.selfdrive.modeld.dsp.compile import lower, parse
...
def verify_pkl(path, iters=30):
  ...
  from openpilot.selfdrive.modeld.dsp.megakernel import MegakernelLayout, megakernel
